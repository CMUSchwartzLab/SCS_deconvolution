#!/bin/bash
#This is an example script to call DataSimulation.py for tumor GBM07
...
#The call is to simulate 3, 6, 9, 33, 99 tumor samples from the SCS data from GBM07
#At least the directories will need to be changed by the user depending on the user's file naming conventions
python DataSimulation.py '/pghbio/cure/hylei/TumorDecompose/' 9_28 GBM07 3 [10,0.1,0.01] 40 True
python DataSimulation.py '/pghbio/cure/hylei/TumorDecompose/' 9_28 GBM07 6 [10,0.1,0.01] 40 True
python DataSimulation.py '/pghbio/cure/hylei/TumorDecompose/' 9_28 GBM07 9 [10,0.1,0.01] 40 True
python DataSimulation.py '/pghbio/cure/hylei/TumorDecompose/' 9_28 GBM07 33 [10,0.1,0.01] 40 True
python DataSimulation.py '/pghbio/cure/hylei/TumorDecompose/' 9_28 GBM07 99 [10,0.1,0.01] 40 True

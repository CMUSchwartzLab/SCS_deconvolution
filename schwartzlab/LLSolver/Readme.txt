...
DecomposeSolver.py will in turn use one of 
  ...
  GurobiILP_solver.py
  SCIP_solver.py
to solve the optimization problems in whichever of the two formulations is chosen.
NMF_solver.py solves the optimization problem in the phylogeny-free method, while GurobiILP_solver and SCIP_solver solve
the optimization problem in the phylogeny-based method.
